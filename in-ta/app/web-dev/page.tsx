...
export default function WebDevelopmentPage() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Interactive and scalable web-based applications",
  ...
  return (
    <div className="bg-black text-white font-sans min-h-screen relative overflow-hidden">
      ...
      >
        ...
        >
          Building cutting-edge digital experiences tailored to your vision
        </motion.p>
      </motion.section>
      ...
      <section ref={processRef} className="py-32 px-8 max-w-6xl mx-auto relative z-10">
        ...
        >
          {[
            { step: "Discovery", desc: "We analyze your needs and goals" },
            { step: "Design", desc: "Creating stunning, user-friendly designs" },
            { step: "Development", desc: "Building with modern technologies" },
            { step: "Launch", desc: "Testing and deployment" },
          ].map((item, idx) => (
            <motion.div
              key={idx}
              variants={cardVariants}
      ...
      <section ref={whyUsRef} className="py-32 px-8 max-w-4xl mx-auto relative z-10">
        ...
        >
          {[
            { title: "Expert Team", desc: "Experienced developers and designers" },
            { title: "Modern Tech", desc: "Latest frameworks and tools" },
            { title: "Custom Solutions", desc: "Tailored to your business needs" },
            { title: "Support", desc: "Ongoing maintenance and support" },
          ].map((item, idx) => (
            <motion.div
              key={idx}
              variants={cardVariants}
      ...
      <section ref={ctaRef} className="py-32 px-8 text-center relative z-10">
        ...
        >
          ...
          >
            Contact us today to start your web development journey
          </motion.p>
          <motion.button
