...
export default function InterfaceDesignPage() {
  ...
  const services: Service[] = [
    {
      title: "UI/UX Design",
      description: "Intuitive and beautiful interface designs",
      icon: "M4 5a2 2 0 012-2h12a2 2 0 012 2v14a2 2 0 01-2 2H6a2 2 0 01-2-2V5z"
    },
    {
      title: "Frontend Development",
      description: "Pixel-perfect implementation with modern frameworks",
  ...
  return (
    <>
      <Head>
        <title>Interface Design & Frontend Services | Your Company</title>
        <meta name="description" content="Professional UI/UX design and frontend development services for exceptional digital experiences." />
      ...
      <div className="bg-black text-white font-sans min-h-screen relative overflow-hidden">
        ...
        >
          ...
          >
            Crafting seamless UI/UX and frontend experiences
          </motion.p>
        </motion.section>
        ...
        <section ref={processRef} className="py-32 px-8 max-w-6xl mx-auto relative z-10">
          ...
          >
            {[
              { step: "Research", desc: "User research and analysis" },
              { step: "Wireframing", desc: "Creating initial layouts and flows" },
              { step: "Design", desc: "Crafting polished UI designs" },
              { step: "Development", desc: "Building responsive frontend code" },
            ].map((item, idx) => (
              <motion.div
                key={idx}
                variants={cardVariants}
        ...
        <section ref={whyUsRef} className="py-32 px-8 max-w-4xl mx-auto relative z-10">
          ...
          >
            {[
              { title: "User-Centric", desc: "Focus on exceptional user experiences" },
              { title: "Technical Expertise", desc: "Proficient in modern frontend tech" },
              { title: "Design Innovation", desc: "Creative and modern UI solutions" },
              { title: "Collaboration", desc: "Close partnership with clients" },
            ].map((item, idx) => (
              <motion.div
                key={idx}
                variants={cardVariants}
        ...
        <section ref={ctaRef} className="py-32 px-8 text-center relative z-10">
          ...
          >
            ...
            >
              Let’s create stunning UI/UX and frontend solutions together
            </motion.p>
            <motion.button
